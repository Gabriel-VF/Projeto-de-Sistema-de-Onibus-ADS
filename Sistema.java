...
public class Sistema {
	...
	static String[] criarLinhaVerticais(String nome, String rota, String horario, double valor,
		...
		String[] linhasVerticais = new String[NUMERO_VALORES];
		...
		for (int i = 0; i < NUMERO_VALORES; i++) {
			linhasVerticais[i] = offset[i] + CHAR_VERTICAL;
		}
	...
	static void imprimirOnibusInfo(String[] listaNomes, String[] listaRotas, String[] listaHorarios,
		...
		// -2 para compensar pelos cantos que vão ser adicionados
	...
	public static void main(String[] args) {
		String[] listaNomes = { "onibus 1", "onibus 2", "onibus 3", "onibus 4"};
		...
		while (true) {
			...
			System.out.print(String.format("Escolha seu ônibus [1-%s] ou digite 0 para sair: ", listaNomes.length));
			...
			System.out.print(String.format("Escolha seu assento [1-%s] ou digite 0 para voltar: ", NUMERO_ASSENTOS));
